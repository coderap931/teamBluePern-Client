...
[Click me][ServerURL] to view our Server repository for GameChest.
...
**Fully Featured Completion Date:** 12/16 
...
| *12/17* | The landing page is updated with a graphic I designed to direct the user to the sidebar to open the GameChest instead of a blank landing page. Animated, gradient background is default background for all packages unless component writes over the background. Nearly ready to deploy large UI update | Redesigned the home page. Updated the custom game form heavily and incorporated it with the update feature as well. This ended up being the reason why were not able to deploy yet as we need to update server side acceptance for the forms now due to expanded options. May need to clear database. As reflected in Login+Register update on same date, none of this is currently added to live build until debugged with server side. 
...
- [App.js Completed and functional me Alex and Adam added view by id and view all fetch to app.js instead of making components]
  ...
  [//]: # (These are reference links used in the body of this note and get stripped out when the markdown processor does its job. There is no need to format nicely because it shouldn't be seen.)
   ...
   [ServerURL]: <https://github.com/coderap931/teamBluePern-Server>
